    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "İlber Ortaylı, Türk tarihçi, akademisyen ve yazar. Türk Tarih Kurumu Şeref Üyesidir. Ortaylı, Uluslararası Osmanlı Etütleri Komitesi yönetim kurulu üyesi ve Avrupa İranoloji Cemiyeti ve Avusturya-Türk Bilimler Forumu üyesidir.", 1947, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8507), "İlber", true, true, false, "Ortaylı", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8525), "ilber-ortayli.jpg", "ilber-ortayli-1" },
                    { 2, "Charlotte Perkins Gilman, ya da Charlotte Perkıns Stetson, önde gelen Amerikalı feminist, sosyolog, romancı, kısa hikâye, şiir ve kurmaca olmayan metinler yazarı ve sosyal reform eğitmeni. Ütopik bir feministti ve alışılmışın dışındaki konsept ve yaşam tarzından dolayı gelecek nesillere örnek teşkil etti.", 1860, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8531), "Charlotte Parkins", true, false, false, "Gilman", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8532), "charlotte-parkins-gilman.jpg", "charlotte-parkins-gilman-2" },
                    { 3, "Herbert George Wells ya da daha çok tanındığı adla H. G. Wells, Dünyaların Savaşı, Görünmez Adam, Dr. Moreau'nun Adası ve Zaman Makinesi adlı bilimkurgu romanlarıyla tanınan ama neredeyse edebiyatın her dalında birçok eser vermiş olan İngiliz yazardır. Sosyalist olduğunu açıkça söyleyen H.G. Wells'in çoğu eserinde önemli ölçüde siyasi ve sosyal yorumlar bulunmaktadır. Jules Verne gibi gelecekteki teknolojik gelişmeleri anlattığı kitaplarıyla bilimkurgu dalının öncülerinden hatta yaratıcılarından sayılmaktadır.", 1866, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8535), "Herbert George", true, false, false, "Wells", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8536), "herbert-george-wells.jpg", "herbert-george-wells-3" },
                    { 4, "Okula Essex'de gitti. Cambridge'de St. Johns College'e devam ederken Footlights tiyatro kulübünde görev aldı. Pek çok iş denedi. Hastanede hizmetlilik, inşaat işçiliği, kümes temizlikçiliği, bir Arap aile için korumalık yaptı. Daha sonra BBC'de Dr. Who dizisinde yapımcılık ve senaryo editörlüğü yaptı. Dr. Who'nun üç bölümünü yazdı. Monty Pyton grubundan Graham Chapman ile birlikte çalıştı.\r\n\r\nBBC'de yayımlanan The Hitchhiker's Guide to the Galaxy (Otostopçunun Galaksi Rehberi) adlı radyo oyunu ile ünlü oldu. Oyun, kitap olarak da yayımlandı. Bu radyo oyunundan aynı adlı bir bilgisayar oyunu da üretti. Daha sonra Bureaucracy ve Starship Titanic adlı bilgisayar oyunları üzerinde de çalıştı. Starship Titanic sonradan bir kitap olarak da yayımlandı, ancak Adams'ın hem oyun hem de kitap üzerinde çalışacak zamanı olmadığından kitabı Terry Jones yazdı. İleri derecede bir Beatles hayranıydı.", 1982, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8539), "Douglas", true, true, false, "Adams", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8540), "douglas-adams.jpg", "douglas-adams-4" },
                    { 5, "Ray Douglas Bradbury korku ve bilimkurgu tarzlarında yazan Amerikalı bir yazardır. En çok bilinen kitapları 1950'de yazdığı kısa hikâyeler kitabı ve bir roman olan The Martian Chronicles ve 1953'te yazdığı başyapıtı olan Fahrenheit 451'dir. Los Angeles'ta 91 yaşında öldü.", 1920, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8543), "Ray Douglas", true, false, false, "Bradbury", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8545), "ray-douglas-bradbury.jpg", "ray-douglas-bradbury-5" },
                    { 6, "Japon yazardır. Tsugaru Yarımadası’nın merkezi yakınlarında küçük bir kasaba olan Kanagi’de doğdu. Asıl adı Şuuci Tsuşima'dır. Ailedeki siyasetçi olma geleneğine karşı çıkarak, yazar olmaya karar verdi. Yirmi yaşında Tokyo Üniversitesi Fransız Edebiyatı Bölümü’ne kaydını yaptırdı. Hayatının büyük bölümünde esrarkeş, veremli, asabi, kavgacı ve alkolik biri olarak birkaç kez intihar etmeye kalkıştı. Dazai, 1948’de metresiyle birlikte suya atlayarak intihar etti. Ölümünün üzerinden bunca sene geçmesine rağmen, Japonya’da hâlâ ilgi gören bir yazardır. Eserlerinin çoğunluğunda yalnızlığı ele alır. Yalnızlık ön planda iken insanın arayış içinde olması ve insanın varoluşunu, içe dönüklüğünü yani temelde insanı ele alır.", 1909, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8548), "Osamu", true, false, false, "Dazai", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8549), "osamu-dazai.jpg", "osamu-dazai-6" },
                    { 7, "Eric Arthur Blair veya daha bilinen takma adıyla George Orwell 20. yüzyıl İngiliz edebiyatının önde gelen kalemleri arasında yer alan İngiliz romancı, gazeteci ve eleştirmen. En çok, dünyaca ünlü Bin Dokuz Yüz Seksen Dört adlı romanı ve bu romanda yarattığı Big Brother kavramı ile tanınır. ", 1903, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8551), "George", true, false, false, "Orwell", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8552), "george-orwell.jpg", "george-orwell-7" },
                    { 8, "Matt Haig bir İngiliz yazar ve gazetecidir. Çocuklar ve yetişkinler için, genellikle spekülatif kurgu türünde hem kurgu hem de kurgu olmayan kitaplar yazmıştır. Haig, çocuklar ve yetişkinler için hem kurgu hem de kurgu olmayan kitapların yazarıdır. Kurgusal olmayan çalışması Reasons to Stay Alive , Sunday Times'ın en çok satanlar listesinde bir numaraydı ve 46 hafta boyunca Birleşik Krallık'ta ilk 10'da yer aldı. En çok satan çocuk romanı 'Noel Baba ve Ben' şu anda filme uyarlanıyor, yapımcılığını StudioCanal ve Blueprint Pictures üstleniyor.", 1982, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8556), "Matt", true, true, false, "Haig", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8557), "matt-haig.jpeg", "matt-haig-8" },
                    { 9, "Stephen William Hawking, İngiliz fizikçi, kozmolog, astronom, teorisyen ve yazar. Stephen Hawking, Einstein'dan bu yana dünyaya gelen en parlak teorik fizikçi olarak kabul edilmektedir. 12 onur derecesi almıştır. 1982'de CBE ile ödüllendirilmiş, bundan başka birçok madalya ve ödül almıştır. ", 1942, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8560), "Stephen William", true, false, false, "Hawking", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8564), "stephen-william-hawking.jpg", "stephen-william-hawking-9" },
                    { 10, "Fyodor Mihayloviç Dostoyevski, Rus roman yazarıdır. Çocukluğunu sarhoş bir baba ve hasta bir anne arasında geçiren Dostoyevski, annesinin ölümünden sonra Petersburg'daki Mühendis Okulu'na girdi. Babasının ölüm haberini de burada aldı. Okulu başarıyla bitirdikten sonra istihkâm bölüğüne girdi.", 1821, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8569), "Fyodor", true, false, false, "Dostoyevski", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8570), "fyodor-dostoyevski.jpg", "fyodor-dostoyevski-10" },
                    { 11, "Manon Steffan Ros, Galli bir romancı, oyun yazarı, oyun yazarı, senarist ve müzisyendir. Tamamı Galce olan yirmiden fazla çocuk kitabı ve yetişkinler için üç romanın yazarıdır. Ödüllü romanı Blasu, The Seasoning başlığı altında İngilizce'ye çevrildi.", 1983, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8573), "Manon Steffan", true, true, false, "Ros", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8574), "manon-steffan-ros.jpg", "manon-steffan-ros-11" },
                    { 12, "Mustafa Kemal Atatürk, Türk asker ve devlet adamıdır. Türk Kurtuluş Savaşı'nın başkomutanı, Türkiye Cumhuriyeti'nin kurucusu ve ilk cumhurbaşkanıdır.Atatürk; çağdaş, ilerici ve laik bir ulus devlet kurmak için siyasal, ekonomik ve kültürel alanlarda sekülarist ve milliyetçi nitelikte yenilikler gerçekleştirdi. Yabancılara tanınan ekonomik ayrıcalıklar kaldırıldı ve onlara ait üretim araçları ve demir yolları millîleştirildi. Tevhîd-i Tedrîsât Kanunu ile eğitim, Türk hükûmetinin denetimine girdi. Seküler ve bilimsel eğitim esas alındı. Binlerce yeni okul yapıldı. İlköğretim ücretsiz ve zorunlu duruma getirildi. Yabancı okullar devlet denetimine alındı. Köylülerin sırtına yüklenen ağır vergiler azaltıldı. Erkeklerin serpuşlarında ve giysilerinde bazı değişiklikler yapıldı. Takvim, saat ve ölçülerde değişikliklere gidildi. Mecelle kaldırılarak yerine seküler Türk Kanunu Medenisi yürürlüğe konuldu. Kadınların sivil ve siyasal hakları pek çok Batı ülkesinden önce tanındı. Çok eşlilik yasaklandı. Kadınların tanıklığı ve miras hakkı, erkeklerinkiyle eşit duruma getirildi. Benzer olarak, dünyanın çoğu ülkesinden önce olarak Türkiye'de kadınlara ilkin yerel seçimlerde (1930), sonra genel seçimlerde (1934) seçme ve seçilme hakkı tanındı. Ceza ve borçlar hukukunda seküler yasalar yürürlüğe konuldu. Sanayi Teşvik Kanunu kabul edildi. Toprak reformu için çabalandı. Arap harfleri temelli Osmanlı alfabesinin yerine Latin harfleri temelli yeni Türk alfabesi kabul edildi. Halkı okuryazar kılmak için eğitim seferberliği başlatıldı. Üniversite Reformu gerçekleştirildi. Birinci Beş Yıllık Sanayi Planı yürürlüğe konuldu. Sınıf ve durum ayrımı gözeten lakap ve unvanlar kaldırıldı ve soyadları yürürlüğe konuldu. Bağdaşık ve birleşmiş bir ulus yaratılması için Türkleştirme siyaseti yürütüldü.", 1881, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8577), "Mustafa Kemal", true, false, false, "Atatürk", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8578), "mustafa-kemal-ataturk.jpg", "mustafa-kemal-ataturk-12" },
                    { 13, "Yuval Noah Harari, İsrailli tarihçi ve yazardır. İsrailli bir kamu entelektüeli, tarihçi ve Kudüs İbrani Üniversitesi Tarih Bölümü'nde profesör. Popüler bilim en çok satan kitapları Sapiens: İnsanlığın Kısa Tarihi, Homo Deus: Yarının Kısa Tarihi ve 21.Yüzyıl İçin 21 Ders kitabının yazarıdır.", 1976, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8580), "Yuval Noah", true, true, false, "Harari", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8581), "yuval-noah-harari.jpg", "yuval-noah-harari-13" },
                    { 14, "Rus yazar ve asker. Dünya tarihinin en iyi yazarlarından birisi olarak bilinmektedir. Tolstoy, zengin bir ailenin çocuğu olarak Rusya'nın Tula şehrindeki Yasnaya Polyana adlı bir konakta doğdu. Çok küçük yaşlarında önce annesini, sonra babasını kaybetti; yakınlarının elinde büyüdü. Çocukluğundan beri gerçekleri incelemeye karşı büyük bir ilgisi vardı. Fransızcasını ilerletmiş, Voltaire'i ve Jean-Jacques Rousseau'yu okumuş, bu iki yazarın kuvvetli etkisinde kalmıştı. Daha sonraları Yasnaya Polyana'ya dönen Tolstoy, yoksul köylülerin arasına katıldı. İlk eseri olan 'Çocukluk'u bu sıralarda yazdı.", 1828, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8585), "Lev Nikolayeviç", true, false, false, "Tolstoy", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8587), "lev-nikolayevic-tolstoy.jpg", "lev-nikolayevic-tolstoy-14" },
                    { 15, "Afşin Kum Kimdir? Afşin Kum, 1972 İzmir doğumlu. Boğaziçi Üniversitesinde bilgisayar mühendisliği, Bilgi Üniversitesinde sinema-televizyon öğrenimi gördü. 1997'den bu yana çeşitli kurumlarda yazılımcı ve yönetici olarak çalıştı.", 1972, new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8590), "Afşin", true, true, false, "Kum", new DateTime(2023, 5, 23, 21, 22, 42, 995, DateTimeKind.Local).AddTicks(8591), "afsin-kum.jpg", "afsin-kum-15" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1370), "Bilim Kurgu Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1379), "Bilim Kurgu", "bilim-kurgu" },
                    { 2, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1382), "Bilim ve Mühendislik Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1382), "Bilim ve Mühendislik", "bilim-ve-muhendislik" },
                    { 3, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1384), "Distopya Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1385), "Distopya", "distopya" },
                    { 4, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1386), "Dünya Tarihi Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1387), "Dünya Tarihi", "dunya-tarihi" },
                    { 5, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1388), "Edebiyat Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1389), "Edebiyat", "edebiyat" },
                    { 6, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1391), "Fizik Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1391), "Fizik", "fizik" },
                    { 7, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1393), "İnsan ve Toplum Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1394), "İnsan ve Toplum", "insan-ve-toplum" },
                    { 8, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1395), "Kişisel Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1396), "Kişisel Gelişim", "kisisel-gelisim" },
                    { 9, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1398), "Popüler Bilim Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1398), "Popüler Bilim", "populer-bilim" },
                    { 10, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1400), "Romanlar", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1400), "Roman", "roman" },
                    { 11, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1402), "Rus Edebiyatı Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1402), "Rus Edebiyatı", "rus-edebiyati" },
                    { 12, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1404), "Söyleşi Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1405), "Söyleşi", "soylesi" },
                    { 13, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1406), "Tarih Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1407), "Tarih", "tarih" },
                    { 14, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1408), "Türkiye Tarihi Kitapları", true, false, new DateTime(2023, 5, 23, 21, 22, 42, 999, DateTimeKind.Local).AddTicks(1409), "Türkiye Tarihi", "turkiye-tarihi" }
                });
