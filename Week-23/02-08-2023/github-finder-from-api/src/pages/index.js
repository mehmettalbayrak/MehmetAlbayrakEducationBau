...
export default function Home() {
  ...
  //useEffect hook'u ikinci parametresine boş dizi vererek kullanırsak, içindeki kodlar sadece component ilk çalıştığı zaman çalışır.
  ...
  //useEffect hook'unun ikinci parametresindeki state'e hangi state'i yazarsak, o state güncellendiğinde bu hook içindeki kodlar çalışır.
  useEffect(() => {
    setLoading(!loading);
  }, [users]);
  ...
  return (
    <>
      <Head>
        <title id="github">Github Finder</title>
        <meta
          name="description"
          content="Mehmet Albayrak tarafından hazırlanmıştır"
        />
