...
namespace BooksApp.MVC.Areas.Admin.Controllers
{
    ...
    public class AuthorController : Controller
    {
        ...
        public AuthorController(IAuthorService authorManager, INotyfService notyf)
        {
        ...
        public async Task<IActionResult> SoftDelete(int id)
        {
            ...
            author.ModifiedDate = DateTime.Now;
            _authorManager.Update(author);
            _notyf.Success("Kayıt silinmiştir. Geri almak için ilgili bölüme geçiniz.");

            return author.IsDeleted == true ? RedirectToAction("Index") : RedirectToAction("DeletedIndex");
        }
        #endregion
