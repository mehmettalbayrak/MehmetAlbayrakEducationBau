...
namespace BooksApp.MVC.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<User> userManager, INotyfService notify, SignInManager<User> signInManager, IEmailSender smtpEmailSender, ICartService cartManager)
        {
