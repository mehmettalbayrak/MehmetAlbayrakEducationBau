...
builder.Services.Configure<IdentityOptions>(options =>
{
    ...
    options.Lockout.DefaultLockoutTimeSpan = TimeSpan.FromMinutes(3);//Üst üste izin verilen kez hatalý giriþ yapmaya çalýþýlan hesap hangi süreyle kilitlenecek?
